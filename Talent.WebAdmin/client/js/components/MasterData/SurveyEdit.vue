    ...
    <div>
        ...
        <div class="row">
            <div class="col col-md-12">
                <!--TITLE-->
                <h3 class="mb-4"><fa icon="database"></fa> Master Data > Survey > <span class="talent_font_red">Edit Survey</span></h3>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                <input name="title" v-validate="'required'" v-model="surveyInsert.title" class="form-control" />
                            </div>
                        </div>
                        <br />
                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <textarea name="question" v-validate="'required'" v-model="survey.question" class="form-control talent_textarea"></textarea>
                                    </div>
                                    <br />
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                                ...
                                                <table class="talent_matrix talent_nopadding">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th v-for="(m, index) in listMatrix[indexQuestion].measurement">
                                                                <textarea name="Matrix Choice" v-validate="'required|max:64'" class="form-control" :placeholder="'Insert Measurement ' + (index + 1)" v-model="listMatrix[indexQuestion].measurement[index]" maxlength="64"></textarea>
                                                            </th>
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(option, indexMatrix) in listMatrix[indexQuestion].option">
                                                            <td><textarea name="Matrix Question" v-validate="'required|max:64'" class="form-control" :placeholder="'Insert Option ' + (indexMatrix + 1)" v-model="listMatrix[indexQuestion].option[indexMatrix]" maxlength="64"></textarea></td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                        ...
                                        <div v-for="(choice, indexMultipleChoice) in survey.choice" class="row justify-content-center">
                                            <div class="col-md-12">
                                                <div class="row align-content-center mb-3">
                                                    ...
                                                    <div class="col-md-11">
                                                        <input name="multiplechoice choice" v-validate="'required'" v-model="choice.choice" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div v-for="(choice, indexRating) in survey.choice" :key="indexRating" class="row justify-content-center">
                                            <div class="col-md-12">
                                                <div class="row align-content-center mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input name="rating choice" v-validate="'required'" v-model="choice.choice" class="form-control" />
                                                    </div>
                                                    <div class="col-md-1 d-flex align-items-center justify-content-center">
                                                        <!--Remove-->
                                        ...
                                        <div v-for="(choice, indexChecklist) in survey.choice" class="row justify-content-center">
                                            <div class="col-md-12">
                                                <div class="row align-content-center mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input name="checklist choice" v-validate="'required'" v-model="choice.choice" class="form-control" />
                                                    </div>
                                                    <div class="col-md-1 d-flex align-items-center justify-content-center">
                                                        <!--Remove-->
                                    ...
                                    <div class="col-md-12" v-else-if="survey.surveyQuestionTypeId == 5">
                                        <div class="justify-content-between mb-3">
                                            <div class="col-md-12">
                                                <img class="h-100 w-100" :src="QuestionImage[indexQuestion] ? (QuestionImage[indexQuestion].FileUpload[0].imageData ? QuestionImage[indexQuestion].FileUpload[0].imageData : '/upload-image2.png') : '/upload-image2.png'" />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10 mb-4">
                                                        <div>
                                                            ...
                                                            <div class="custom-file">
                                                                <input name="tebak gambar choice" v-validate="'required'" type="file" class="custom-file-input" id="customFile" @change.prevent="handler(indexQuestion, indexTebakGambar, $event)" />
                                        ...
                                        <div v-for="(leftMatchingChoice, index) in survey.matchingChoices.leftChoices" class="" :key="index">
                                            <div class="row ">
                                                        ...
                                                        <div class="col-md-6 talent_borderright ">
                                                            <div class="talent_marginbottom h-100">
                                                                <div class="input-group mb-3 talent_nomargin">
                                                                    ...
                                                                    <select class="form-control talent_noroundborder_bottom" @change="matchingChangeType" v-model="surveyInsert.question[indexQuestion].matchingChoices.leftChoices[index].type">
                                                                        <option value="image">Image</option>
                                                                        <option value="text">Text</option>
                                                                    </select>
                                                                </div>
                                                                <div v-if="surveyInsert.question[indexQuestion].matchingChoices.leftChoices[index].type === 'image'">
                                                                    <img class="h-100 w-100" :src="(matchingImageFormData[indexQuestion] && matchingImageFormData[indexQuestion].data[index] && matchingImageFormData[indexQuestion].data[index].leftImage) ? matchingImageFormData[indexQuestion].data[index].leftImage : '/upload-image2.png'" for="customFile" />
                                                                    <div class="custom-file">
                                                                        <input type="file" class="custom-file-input talent_noroundborder_top" v-validate="surveyInsert.question[indexQuestion].matchingChoices.leftChoices[index].blobId == null ? 'required' : ''" name="matching left image choice" accept="image/*" @change.prevent="loadFileChoice($event, indexQuestion,index,surveyInsert.question[indexQuestion].matchingChoices.leftChoices[index],true )" id="customFile">
                                                                        <label class="custom-file-label talent_textshorten talent_noroundborder_top" for="customFile">{{surveyInsert.question[indexQuestion].matchingChoices.leftChoices[index].imageUpload? surveyInsert.question[indexQuestion].matchingChoices.leftChoices[index].imageUpload.fileName : 'Choose File'}}</label>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-md-6 ">
                                                            <div class="talent_marginbottom h-100">
                                                                <div class="input-group mb-3 talent_nomargin">
                                                                    ...
                                                                    <select class="form-control talent_noroundborder_bottom" @change="matchingChangeType" v-model="surveyInsert.question[indexQuestion].matchingChoices.rightChoices[index].type">
                                                                        <option value="image">Image</option>
                                                                        <option value="text">Text</option>
                                                                    </select>
                                                                </div>
                                                                <div v-if="surveyInsert.question[indexQuestion].matchingChoices.rightChoices[index].type === 'image'">
                                                                    <img class="h-100 w-100" :src="(matchingImageFormData[indexQuestion] && matchingImageFormData[indexQuestion].data[index] && matchingImageFormData[indexQuestion].data[index].rightImage) ? matchingImageFormData[indexQuestion].data[index].rightImage : '/upload-image2.png'" for="customFile" />
                                                                    <div class="custom-file">
                                                                        <input type="file" class="custom-file-input talent_noroundborder_top" id="customFile" v-validate="surveyInsert.question[indexQuestion].matchingChoices.rightChoices[index].blobId == null ? 'required' : ''" name="matching right image choice" accept="image/*" @change.prevent="loadFileChoice($event,indexQuestion, index,surveyInsert.question[indexQuestion].matchingChoices.rightChoices[index],false)">
                                                                        <label class="custom-file-label talent_textshorten talent_noroundborder_top" for="customFile">{{surveyInsert.question[indexQuestion].matchingChoices.rightChoices[index].imageUpload? surveyInsert.question[indexQuestion].matchingChoices.rightChoices[index].imageUpload.fileName : 'Choose File'}}</label>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="col-md-2 d-flex align-items-center ">
                                                    <div v-if="index != survey.matchingChoices.leftChoices.length - 1" class="text-center" @click="removeMatchingRow(survey,index)"><a class="h-100 w-100 talent_cursorpoint"><fa icon="trash-alt"></fa></a></div>
                                                    <div v-if="index == survey.matchingChoices.leftChoices.length - 1" class="text-center" @click="addMatchingRow(indexQuestion,index+1)"><a class="h-100 w-100 talent_cursorpoint"><fa icon="plus-circle"></fa></a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="d-flex align-items-end flex-column">
                                <div>
                                    ...
                                    <button class="btn talent_bg_lightgreen talent_font_white" :disabled="!crud.update" @click.prevent="SaveSurvey()">
                                        Save
                                    </button>
                                    <button class="btn talent_bg_blue talent_font_white" :disabled="!crud.update" @click.prevent="SubmitSurvey()">
                                        Submit
                                    </button>
                                </div>
                            </div>
...
<script lang="ts">
    ...
    import { SurveyMatrixModel, SurveyMatchingChoiceFormModel, FileContent, BlobModel, SurveysService, SurveyInsert, SurveyQuestion, SurveyChoice, AreaViewModel, PositionViewModel, RegionViewModel, DealerViewModel, ProvinceViewModel, CityViewModel, OutletViewModel, ReleaseTrainingService, SurveyQuestionType, SurveyInitialize, BlobService as BlobServiceNswag, UserAccessCRUD, UserPrivilegeSettingsService, OutletCompleteViewModel, SurveyMatrixChoicesModel, SurveyMatchingChoice } from '../../services/NSwagService'
    import IFileContent from '../../models/IFileContent';
    import { faAlignRight } from '@fortawesome/free-solid-svg-icons';

    @Component({
        props: ["edit", "success-message-show", "success-message", "survey-id"],
        created: async function (this: SurveyEdit) {
            this.isBusy = true;
    ...
    export default class SurveyEdit extends Vue {
        ...
        surveyInsert: SurveyInitialize = {
            surveyId: null, title: '', startDate: null, endDate: null, outlet: [], position: [], question: [], area: [], city: [], dealer: [], province: []
        }
        ...
        async loadFileChoice(e, questionIndex: number, index: number, choice: SurveyMatchingChoiceFormModel, isLeft: boolean) {
            ...
            reader.onload = (e) => {
                ...
                let rowToUpdate = this.matchingImageFormData[questionIndex].data[index];
                if (isLeft) {
                    rowToUpdate.leftImage = result
                } else {
                    rowToUpdate.rightImage = result
                }
            }
        ...
        async AddSurvey() {
            ...
            this.AnswerImage.push({ FileUpload: [{ fileName: '', formData: { base64: "", contentType: "", fileName: "" }, imageData: '' }] })
            this.QuestionImage.push({ FileUpload: [{ fileName: '', formData: { base64: "", contentType: "", fileName: "" }, imageData: '' }] })
        ...
        get outletLength() {
            return this.surveyInsert.outlet.length
        }
        get positionLength() {
        ...
        async Initialize() {
            ...
            //this.selectedArea = this.surveyInsert.area;
            //this.selectedProvince = this.surveyInsert.province;
            //this.selectedCity = this.surveyInsert.city;
            //this.selectedDealer = this.surveyInsert.dealer;

            var areaIdList = this.surveyInsert.area.map(Q => Q.areaId);
            this.selectedArea = this.listAreaGroup[0].ListOption.filter(Q => areaIdList.includes(Q.areaId)).map(x => x);

            var dealerIdList = this.surveyInsert.dealer.map(Q => Q.dealerId);
            this.selectedDealer = this.listDealerGroup[0].ListOption.filter(Q => dealerIdList.includes(Q.dealerId)).map(x => x);

            var provinceIdList = this.surveyInsert.province.map(Q => Q.provinceId);
            this.selectedProvince = this.listProvinceGroup[0].ListOption.filter(Q => provinceIdList.includes(Q.provinceId)).map(x => x);

            var cityIdList = this.surveyInsert.city.map(Q => Q.cityId);
            this.selectedCity = this.listCityGroup[0].ListOption.filter(Q => cityIdList.includes(Q.cityId)).map(x => x);

            var positionIdList = this.surveyInsert.position.map(Q => Q.positionId);
            this.surveyInsert.position = this.listPositionGroup[0].ListOption.filter(Q => positionIdList.includes(Q.positionId)).map(x => x);


            var currentSelectedOutletIds = this.surveyInsert.outlet.map(Q => Q.outletId);
            this.editListGroup();
            ...
            for (var i = 0; i < this.surveyInsert.question.length; i++) {
                this.QuestionImage.push({ FileUpload: [] });
                this.selectedHotspotOption.push(1);
                this.AnswerImage.push({
                    FileUpload: []
                });
                this.listMatrix.push({ question: "Question", measurement: [null, null, null, null, null], option: [null] });

                var questionBlobId = this.surveyInsert.question[i].blobId;
                if (questionBlobId != null) {
                    this.QuestionImage[i].FileUpload = [];
                    this.QuestionImage[i].FileUpload.push({
                        fileName: '',
                ...
                //Matrix
                if (this.surveyInsert.question[i].surveyQuestionTypeId == 12) {
                    this.listMatrix[i].option = [];
                    this.listMatrix[i].measurement = [];
                    for (var a = 0; a < this.surveyInsert.question[i].matrixChoice.matrixQuestion.length; a++) {
                        this.listMatrix[i].option.push(this.surveyInsert.question[i].matrixChoice.matrixQuestion[a].question);
                    }
                    for (var a = 0; a < this.surveyInsert.question[i].matrixChoice.matrixChoice.length; a++) {
                        this.listMatrix[i].measurement.push(this.surveyInsert.question[i].matrixChoice.matrixChoice[a].text);
                    }
                }
        ...
        async SubmitSurvey() {
            ...
            this.isBusy = true
            let validateScope = [
                'title', 'area', 'region', 'dealer', 'province', 'city', 'outlet', 'position', 'period start', 'period end', 'multiplechoice choice', 'rating choice', 'checklist choice', 'Matrix Question', 'Matrix Choice',
                'matching right image choice', 'question', 'matching right text choice',
                'matching left image choice', 'matching left text choice'
            ]

            let valid = await this.$validator.validateAll(validateScope);
            ...
            this.setOutlet();
            await this.surveyAPI.updateSubmitSurvey(this.surveyInsert, this.surveyId);
        ...
        async SaveSurvey() {
            ...
            let validateScope = [
                'title', 'question', 'area', 'region', 'dealer', 'province', 'city', 'outlet', 'position', 'period start', 'period end', 'multiplechoice choice', 'rating choice', 'checklist choice', 'Matrix Question', 'Matrix Choice',
                'matching right image choice', 'matching right text choice',
                'matching left image choice', 'matching left text choice'
            ]
            ...
            await this.surveyAPI.updateSaveSurvey(this.surveyInsert, this.surveyId);
        ...
        async fileChangeQuestion(e, indexQuestion: number, index: number) {
            ...
            this.QuestionImage[indexQuestion].FileUpload[index].formData.fileName = e.target.files[0].name;
        ...
        async fileChange(e, indexQuestion: number, index: number) {
            ...
            this.AnswerImage[indexQuestion].FileUpload[index].formData.fileName = file.name;
