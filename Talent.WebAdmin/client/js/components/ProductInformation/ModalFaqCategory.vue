            ...
            <div class="modal-content">
                ...
                <div class="row px-4 py-4">
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      <div class="col-md-12">
                        <label>FAQ Category Name<span class="talent_font_red"> *</span></label>
                ...
                <div class="col-md-12 talent_magin_small mt-3">
                    <div class="row align-items-center justify-content-between">
                        <div class="col d-flex py-0 pl-0 pr-4">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Search By Name" v-model="params.ProductFaqCategoryName"/>
                            </div>
                        </div>
                ...
                <div class="w-100 talent_overflowx mt-3">
                    <table class="table table-bordered table-responsive-md talent_table_padding">
                        ...
                        <tbody>
                            <tr v-for="dictionary in categories" :key="dictionary.productFaqCategoryId">
                                <td>
  ...
  components: { ModalDelete },
    ...
    methods: {
      async fetchCategories() {
        ...
        try {
            const res = await this.service.getAllProductFAQCategories(this.params)
            this.categories = res.productFAQCategories
            this.totalData = res.totalProductFAQCategories
        } catch (err) {
            console.error(err)
        }
      },
      async handleSave() {
        ...
        try {
          if(this.selectedEditData) {
            await this.service.updateProductFAQCategory({
              productId: this.id,
              productFaqCategoryId: this.selectedEditData.productFaqCategoryId,
              "productFaqCategoryName": this.categoryName
            })

          } else {
            await this.service.createProductFAQCategory({
              productId: this.id,
              "productFaqCategoryName": this.categoryName
            })
          }
      ...
      async handleDelete() {
        this.isBusy = true
        try {
          await this.service.deleteProductFAQCategory(this.selectedData.productFaqCategoryId)
          this.fetchCategories()
          this.success = true
          this.categoryName = ''
        } catch (err) {
      ...
      handleEdit(category) {
        ...
        this.categoryName = category.productFaqCategoryName
      }
    },
    computed: {
      id() {
