            ...
            <div class="modal-content">
                ...
                <div class="row px-4 py-4">
                        ...
                        <div class="input-group talent_front">
                          ...
                          <div class="d-flex align-items-center w-100">
                            <div class="container-upload">
                              ...
                              <object v-if="image.contentType === 'pdf'" class="h-100 w-100 min-heigth-full" type="application/pdf" width="100%" height="100%" :data="selectedFile ? selectedFile : `/upload-image2.png`" for="customFiled" />
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="input-group talent_front">
                          <label for="" class="w-100">Upload File</label>
                          <div class="d-flex align-items-center w-100">
                            <!-- <div class="container-upload"> -->
                ...
                <div class="col-md-12 talent_magin_small mt-3">
                    <div class="row align-items-center justify-content-between">
                        <div class="col d-flex py-0 pl-0 pr-4">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Search By Name" v-model="params.cms_SubContentName"/>
                            </div>
                        </div>
                ...
                <div class="w-100 talent_overflowx mt-3">
                    <table class="table table-bordered table-responsive-md talent_table_padding">
                        ...
                        <tbody>
                            <tr v-for="dictionary in categories" :key="dictionary.cms_SubContentId">
                                <td>
                                ...
                                <td class="talent_nopadding_important">
                                    <button type="button" class="btn btn-block talent_bg_red talent_font_white" 
                                            data-toggle="modal"
                                            data-target="#modalDeleteCmsSubContent" @click="selectedData = dictionary">
                                    Remove
                                    </button>
                                </td>
                            </tr>
  ...
  components: { ModalDelete },
    ...
    methods: {
      async fetchCategories() {
        ...
        this.params.Cms_SubContentCategory = this.type
        try {
            const res = await this.service.getAllCMSSubContent(this.params)
            this.categories = res.cmsSubContents
            this.totalData = res.totalCmsSubContents
        } catch (err) {
            console.error(err)
        }
      ...
      async handleSave() {
        ...
        try {
          if(this.selectedEditData) {
            const body = {
              cms_SubContentId: this.selectedEditData.cms_SubContentId,
              "cmsSubContentPicContent": {
              ...
              "cmsSubContentFileContent": {
                "base64": this.imageFile.base64,
                "fileName": this.imageFile.fileName,
                "contentType": this.imageFile.contentType
              },
              "cmsSubContentVidContent": {
                "base64": this.image.contentType == 'mp4' ? this.image.base64 : '',
                "fileName": this.image.contentType == 'mp4' ? this.image.fileName : '',
                "contentType": this.image.contentType == 'mp4' ? this.image.contentType : ''
              },
              "cms_SubContentDescription": this.description,
              "cms_SubContentName": this.categoryName,
              "cms_SubContentCategory": this.type,
              "cms_SubContentSequence": Number(this.sequence),
              "cms_SubContentIsSequence": this.isSequence,
            ...
            await this.service.updateCMSSubContent(body)

          } else {
            await this.service.createCMSSubContent({
              "cmsSubContentPicContent": {
                "base64": this.image.contentType != 'mp4' ? this.image.base64 : '',
                "fileName": this.image.contentType != 'mp4' ? this.image.fileName : '',
                "contentType": this.image.contentType != 'mp4' ? this.image.contentType : ''
      ...
      async handleDelete() {
        this.isBusy = true
        try {
          await this.service.deleteCMSSubContent(this.selectedData.cms_SubContentId)
          this.fetchCategories()
          this.success = true
          this.image= {
            base64: '',
      ...
      handleEdit(category) {
        ...
        this.categoryName = category.cms_SubContentName
        this.sequence = category.cms_SubContentSequence
        this.isSequence = category.cms_SubContentIsSequence
        this.description = category.cms_SubContentDescription
