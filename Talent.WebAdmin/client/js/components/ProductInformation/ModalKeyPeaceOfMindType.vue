            ...
            <div class="modal-content">
                ...
                <div class="row px-4 py-4">
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      <div class="col-md-12">
                        <label>Key Piece Of Mind Type Name</label>
                ...
                <div class="col-md-12 talent_magin_small mt-3">
                    <div class="row align-items-center justify-content-between">
                        <div class="col d-flex py-0 pl-0 pr-4">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Search By Name" v-model="params.keyPieceOfMindTypeName"/>
                            </div>
                        </div>
                ...
                <div class="w-100 talent_overflowx mt-3">
                    <table class="table table-bordered table-responsive-md talent_table_padding">
                        ...
                        <tbody>
                            <tr v-for="dictionary in categories" :key="dictionary.keyPieceOfMindTypeId">
                                <td>
  ...
  components: { ModalDelete },
    ...
    methods: {
      async fetchCategories() {
        try {
            const res = await this.service.getAllKeyPeaceOfMindType(this.params)
            this.categories = res.keyPieceOfMindTypes
            this.totalData = res.totalKeyPieceOfMindTypes
        } catch (err) {
            console.error(err)
        }
      },
      async handleSave() {
        ...
        try {
          if(this.selectedEditData) {
            const body = {
              keyPieceOfMindTypeId: this.selectedEditData.keyPieceOfMindTypeId,
              "keyPieceOfMindTypeName": this.categoryName,
              "keyPieceOfMindTypeDescription": this.description,
              productFileContent : {
            ...
            await this.service.updateKeyPeaceOfMindType(body)

          } else {
            await this.service.createKeyPeaceOfMindType({
              "keyPieceOfMindTypeName": this.categoryName,
              "keyPieceOfMindTypeDescription": this.description,
              productFileContent: {
                base64: this.image.base64,
      ...
      async handleDelete() {
        this.isBusy = true
        try {
          await this.service.deleteKeyPeaceOfMindType(this.selectedData.keyPieceOfMindTypeId)
          this.fetchCategories()
          this.success = true
          this.categoryName = ''
          vm.image= {
      ...
      handleEdit(category) {
        ...
        this.categoryName = category.keyPieceOfMindTypeName
        this.selectedFile = category.imageUrl
        this.image.contentType = category.fileTypeBlob
        this.description = category.keyPieceOfMindTypeDescription
      },
