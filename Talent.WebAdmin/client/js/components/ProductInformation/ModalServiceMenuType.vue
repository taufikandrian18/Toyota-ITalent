            ...
            <div class="modal-content">
                ...
                <div class="row px-4 py-4">
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      <div class="col-md-12">
                        <label>Service Tips Type Name</label>
                ...
                <div class="col-md-12 talent_magin_small mt-3">
                    <div class="row align-items-center justify-content-between">
                        <div class="col d-flex py-0 pl-0 pr-4">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Search By Name" v-model="params.ServiceTipTypeName"/>
                            </div>
                        </div>
                ...
                <div class="w-100 talent_overflowx mt-3">
                    <table class="table table-bordered table-responsive-md talent_table_padding">
                        ...
                        <tbody>
                            <tr v-for="dictionary in categories" :key="dictionary.serviceTipTypeId">
                                <td>
  ...
  components: { ModalDelete },
    ...
    methods: {
      async fetchCategories() {
        try {
            const res = await this.service.getAllServiceTipsType(this.params)
            this.categories = res.serviceTipTypes
            this.totalData = res.totalServiceTipTypes
        } catch (err) {
            console.error(err)
        }
      },
      async handleSave() {
        ...
        if(!this.categoryName) {
          this.errored.push({
            key: 'type name',
            value: 'Please fill type name field'
          })
        }
        // if(!this.description) {
        //   this.errored.push({
        ...
        try {
          if(this.selectedEditData) {
            const body = {
              serviceTipTypeId: this.selectedEditData.serviceTipTypeId,
              "serviceTipTypeName": this.categoryName,
              "serviceTipTypeDescription": this.description,
              productFileContent : {
            ...
            await this.service.updateServiceTipsType(body)

          } else {
            await this.service.createServiceTipsType({
              "serviceTipTypeName": this.categoryName,
              "serviceTipTypeDescription": this.description,
              productFileContent: {
                base64: this.image.base64,
      ...
      async handleDelete() {
        this.isBusy = true
        try {
          await this.service.deleteServiceTipsType(this.selectedData.serviceTipTypeId)
          this.fetchCategories()
          this.success = true
          this.categoryName = ''
          vm.image= {
      ...
      handleEdit(category) {
        ...
        this.categoryName = category.serviceTipTypeName
        this.selectedFile = category.imageUrl
        this.image.contentType = category.fileTypeBlob
        this.description = category.serviceTipTypeDescription
      },
