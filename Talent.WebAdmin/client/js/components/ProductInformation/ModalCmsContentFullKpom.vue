    ...
    <div class="modal fade" :id="name" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12 mt-4">
                        <div class="input-group talent_front">
                          <label for="" class="w-100">Media (jpeg/png/mp4/pdf) maks 100MB<span class="talent_font_red"> *</span></label>
                          <div class="d-flex align-items-center w-100">
                            <div class="container-upload">
                              ...
                              <!-- </div> -->
                                <input type="file" :name="`input-manfaat-${this.name}`" :id="`input-manfaat-${this.name}`" style="display: none;" @change="handleChangeFile" accept=".png,.jpg,.jpeg,.mp4,.pdf">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <!-- <div class="col-md-12">
                        <div class="input-group talent_front">
                          ...
                          <div class="container-upload mt-4" v-if="imageFile.contentType === 'pdf'">
                            <object v-if="imageFile.contentType === 'pdf'" class="h-100 w-100 min-heigth-full" type="application/pdf" width="100%" height="100%" :data="selectedFileFile ? selectedFileFile : `/upload-image2.png`" for="customFile" />
                          </div>
                        </div>
                      </div> -->
                      <div class="col-md-12 mt-4">
                ...
                <div class="col-md-12" v-if="image.contentType === 'pdf'" style="height: 800px; overflow: hidden">
                  <div style="height: 800px;overflow: hidden">
                    <object v-if="image.contentType === 'pdf'" class="w-100 h-100" type="application/pdf" width="100%" height="800px" :data="selectedFile ? selectedFile : `/upload-image2.png`" for="customFileFilefiledKPOM" style="height: 800px;z-index: 0;overflow: hidden"/>
                  </div>
                </div>
  ...
  components: { ModalDelete },
    ...
    methods: {
          ...
          if(this.selectedEditData) {
            const body = {
              ...
              "cmsContentPicContent": {
                "base64": this.image.contentType != 'mp4' &&  this.image.contentType != 'pdf' ? this.image.base64 : '',
                "fileName": this.image.contentType != 'mp4' &&  this.image.contentType != 'pdf' ? this.image.fileName : '',
                "contentType": this.image.contentType != 'mp4' &&  this.image.contentType != 'pdf' ? this.image.contentType : ''
              },
              "cmsContentFileContent": {
                "base64": this.image.contentType == 'pdf' ? this.image.base64 : '',
                "fileName": this.image.contentType == 'pdf' ? this.image.fileName : '',
                "contentType": this.image.contentType == 'pdf' ? this.image.contentType : ''
              },
      ...
      handleEdit(category) {
        ...
        this.selectedFile = category.blobUrl ? category.blobUrl : category.videoBlobUrl ? category.videoBlobUrl : category.fileBlobUrl
        this.selectedFileFile = category.fileBlobUrl
        this.selectedFileVideo = category.videoBlobUrl
        this.image = {
          base64: null,
          fileName: category.blobId ? category.blob.name : category.videoBlobUrl ? category.videoBlob.name : category.fileBlob.name,
          contentType: category.blobId ? category.blob.mime : category.videoBlobUrl ? category.videoBlob.mime : category.fileBlob.mime,
        }
        this.imageFile = {
          base64: null,
