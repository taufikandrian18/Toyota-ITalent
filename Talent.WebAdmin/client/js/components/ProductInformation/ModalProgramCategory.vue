            ...
            <div class="modal-content">
                ...
                <div class="row px-4 py-4">
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      <div class="col-md-12">
                        <label>Program Menu Name<span class="talent_font_red"> *</span></label>
                ...
                <div class="col-md-12 talent_magin_small mt-3">
                    <div class="row align-items-center justify-content-between">
                        <div class="col d-flex py-0 pl-0 pr-4">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Search By Name" v-model="params.ProductProgramCategoryName"/>
                            </div>
                        </div>
                ...
                <div class="w-100 talent_overflowx mt-3">
                    <table class="table table-bordered table-responsive-md talent_table_padding">
                        ...
                        <tbody>
                            <tr v-for="dictionary in categories" :key="dictionary.productProgramCategoryId">
                                <td>
                                ...
                                <td class="talent_nopadding_important">
                                    <button type="button" class="btn btn-block talent_bg_red talent_font_white" 
                                            data-toggle="modal"
                                            data-target="#modalDeleteFeature" @click="selectedData = dictionary">
                                    Remove
                                    </button>
                                </td>
                            </tr>
  ...
  components: { ModalDelete },
    ...
    methods: {
      async fetchCategories() {
        ...
        try {
            const res = await this.service.getAllProductProgramCategory(this.params)
            this.categories = res.productProgramCategories
            this.totalData = res.totalProductProgramCategories
        } catch (err) {
            console.error(err)
        }
      },
      async handleSave() {
        ...
        try {
          if(this.selectedEditData) {
            const body = {
              productId: this.id,
              productProgramCategoryId: this.selectedEditData.productProgramCategoryId,
              "productProgramCategoryName": this.categoryName,
              "productProgramCategoryDescription": this.description,
              productFileContent : {
                base64: '',
                fileName: '',
                contentType: ''
            ...
            await this.service.updateProductProgramCategory(body)

          } else {
            await this.service.createProductProgramCategory({
              productId: this.id,
              "productProgramCategoryName": this.categoryName,
              "productProgramCategoryDescription": this.description,
              productFileContent: {
      ...
      async handleDelete() {
        this.isBusy = true
        try {
          await this.service.deleteProductProgramCategory(this.selectedData.productProgramCategoryId)
          this.fetchCategories()
          this.success = true
          this.categoryName = ''
          vm.image= {
      ...
      handleEdit(category) {
        ...
        this.categoryName = category.productProgramCategoryName
        this.selectedFile = category.imageUrl
        this.image.contentType = category.blob.mime
        this.description = category.productProgramCategoryDescription
      },
