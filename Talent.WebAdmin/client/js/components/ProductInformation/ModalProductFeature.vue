            ...
            <div class="modal-content">
                ...
                <div class="row px-4 py-4">
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      <div class="col-md-12">
                        <label>Product Feature Name<span class="talent_font_red"> *</span></label>
                ...
                <div class="col-md-12 talent_magin_small mt-3">
                    <div class="row align-items-center justify-content-between">
                        <div class="col d-flex py-0 pl-0 pr-4">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Search By Name" v-model="params.ProductFeatureName"/>
                            </div>
                        </div>
                ...
                <div class="w-100 talent_overflowx mt-3">
                    <table class="table table-bordered table-responsive-md talent_table_padding">
                        ...
                        <tbody>
                            <tr v-for="dictionary in categories" :key="dictionary.productFeatureId">
                                <td>
  ...
  components: { ModalDelete },
    ...
    methods: {
      async fetchCategories() {
        ...
        try {
            const res = await this.service.getAllProductFeature(this.params)
            this.categories = res.productFeatures
            this.totalData = res.totalProductFeatures
        } catch (err) {
            console.error(err)
        }
      },
      async handleSave() {
        ...
        try {
          if(this.selectedEditData) {
            const body = {
              productFeatureId: this.selectedEditData.productFeatureId,
              productId: this.id,
              "productFeatureName": this.categoryName
            }
            ...
            const res = await this.service.updateProductFeature(body)
            ...
            const res = await this.service.createProductFeature({
              productId: this.id,
              "productFeatureName": this.categoryName,
      ...
      async handleDelete() {
        this.isBusy = true
        try {
          await this.service.deleteProductFeature(this.selectedData.productFeatureId)
          this.fetchCategories()
          this.success = true
          this.categoryName = ''
          vm.image= {
      ...
      handleEdit(category) {
        ...
        this.categoryName = category.productFeatureName
