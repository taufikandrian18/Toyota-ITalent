    ...
    <div class="modal fade" :id="name" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="col-md-12">
                  <div class="container-upload mt-4" v-if="image.contentType === 'pdf'" style="height: 800px !important">
                    <object v-if="image.contentType === 'pdf'" class="h-100 w-100" type="application/pdf" width="100%" height="800px" :data="selectedFile ? selectedFile : `/upload-image2.png`" for="customFileFileFile" style="height: 800px !important;"/>
                  </div>
                </div>
          ...
          if(this.selectedEditData) {
            const body = {
              ...
              "cmsContentPicContent": {
                "base64": !['mp4', 'pdf'].includes(this.image.contentType) ? this.image.base64 : '',
                "fileName": !['mp4', 'pdf'].includes(this.image.contentType) ? this.image.fileName : '',
                "contentType": !['mp4', 'pdf'].includes(this.image.contentType) ? this.image.contentType : ''
              },
              ...
              isDeleteFile: !['pdf'].includes(this.image.contentType),
              isDeleteVid: !['mp4'].includes(this.image.contentType),
              isDeletePic: ['mp4', 'pdf'].includes(this.image.contentType)
            }
