                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="input-group talent_front">
                          <label for="" class="w-100">Images/Video (jpg, png, mp4, pdf)<span class="talent_font_red"> *</span></label>
                          <div class="d-flex align-items-center w-100">
                            <div class="container-upload">
                              ...
                              <!-- </div> -->
                                <input type="file" :name="`input-manfaat-baru-${this.name}`" :id="`input-manfaat-baru-${this.name}`" style="display: none;" @change="handleChangeFile" accept=".png,.jpg,.jpeg,.mp4,.pdf">
                            </div>
                          </div>
                        </div>
                      </div>
