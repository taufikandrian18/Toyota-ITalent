<template>
  <div class="row px-4 py-4 w-100">
    ...
    <div class="col-md-12 mb-3">
      <h5>Contribute Photos</h5>
    </div>
    <div class="col-md-6" v-if="selectedEditData">
      <div class="row">
        <div class="col-md-12">
    ...
    <div class="col-md-12 d-flex justify-content-end mt-4" v-if="selectedEditData">
              ...
              <tbody>
                  <tr v-for="dictionary in productTypes" :key="dictionary.productGalleryId">
                      ...
                      <td class="talent_nopadding_important text-center">
                        ...
                        <button type="button" class="btn btn-block talent_bg_orange" @click="handleChangeStatus(dictionary)">
                          Approve
                        </button>
                      </td>
                  </tr>
    ...
    methods: {
      ...
      async fetchFAQ() {
        try {
          ...
          const res = await this.service.getAllProductGalleryContribute(this.params)
