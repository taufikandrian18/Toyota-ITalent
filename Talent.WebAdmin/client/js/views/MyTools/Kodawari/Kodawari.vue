    ...
    <div class="row mx-0">
      ...
      <div class="col-md-12 mt-3 p-0">
        ...
        <div class="row talent_bg_white talent_padding talent_bg_shadow m-0">
          <banner v-if="page === 'Banner'"/>
          <main-menu v-if="page === 'MainMenu'"/>
          <downloads v-if="page === 'Downloads'"/>
          <guideline v-if="page === 'DealerHOContributionFiles'"/>
        </div>
      </div>
    </div>
...
import Guideline from '../../../components/Kodawari/Detail/Guideline.vue';
    
  @Component({
  components: { ModalDelete, FilterBar, ModalCategory, ModalModel, ProductMenus, BasicInformation, ProductType, Faq, PhotoGallery, Photo, Customer, ProductCompetitor, Tips, Spwa, KodawariMenus, Banner, MainMenu, Downloads, Guideline },
    props: ['claims'],
