...
import UploadGuidelineForm from '../../components/KeyPeaceOfMind/Detail/UploadGuidelineForm.vue';
    
  @Component({
  components: { ModalDelete, FilterBar, ModalCategory, ModalModel, ProductMenus, BasicInformation, ProductType, Faq, PhotoGallery, Photo, Customer, ProductCompetitor, Tips, Spwa, KodawariMenus, Banner, MainMenu, Downloads, KeyPeaceOfMindForm, UploadGuidelineForm },
    props: ['claims'],
