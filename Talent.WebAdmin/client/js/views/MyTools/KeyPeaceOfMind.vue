...
import KeyPeaceOfMindForm from '../../components/KeyPeaceOfMind/Detail/KeyPeaceOfMindForm.vue';
  ...
  @Component({
  components: { ModalDelete, FilterBar, ModalCategory, ModalModel, ProductMenus, BasicInformation, ProductType, Faq, PhotoGallery, Photo, Customer, ProductCompetitor, Tips, Spwa, KodawariMenus, Banner, MainMenu, Downloads, KeyPeaceOfMindForm },
    props: ['claims'],
