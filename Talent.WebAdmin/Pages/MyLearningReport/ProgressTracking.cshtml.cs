...
{
  [Authorize]
  public class ProgressTrackingModel : PageModel
  {
    private readonly UserPrivilegeSettingsService _PrivilegeMan;
    private readonly IContextualService _ContextMan;

    public ProgressTrackingModel(UserPrivilegeSettingsService userPrivilegeSettingsService, IContextualService ics)
    {
