...
namespace Talent.WebAdmin.Pages.MyLearningReport
{
  [Authorize]
  public class CompetencyTrackingModel : PageModel
  {
    private readonly UserPrivilegeSettingsService _PrivilegeMan;
    private readonly IContextualService _ContextMan;

    public CompetencyTrackingModel(UserPrivilegeSettingsService userPrivilegeSettingsService, IContextualService ics)
    {
