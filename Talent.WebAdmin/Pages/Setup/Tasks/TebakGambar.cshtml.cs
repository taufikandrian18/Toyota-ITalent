...
namespace Talent.WebAdmin.Pages.Tasks
{
    [Authorize]
    public class TebakGambarModel : PageModel
    {
        ...
        public TebakGambarModel(UserPrivilegeSettingsService userPrivilegeSettingsService)
        {
