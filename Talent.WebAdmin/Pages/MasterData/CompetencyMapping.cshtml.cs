...
namespace Talent.WebAdmin.Pages.MasterData
{
    ...
    public class CompetencyMappingModel : PageModel
    {
        ...
        public CompetencyMappingModel(UserPrivilegeSettingsService userPrivilegeSettingsService)
        {
            this._PrivilegeMan = userPrivilegeSettingsService;
        }
        public IActionResult OnGet()
        {
            var access = this._PrivilegeMan.AccessPage(PageEnums.CompetencyMapping);
            if (access == false)
            {
